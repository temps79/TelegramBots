...
public abstract class State {
    ...
    protected SendMessage sendChatMessage (String text,String chatId) throws TelegramApiException {
        return new SendMessage().
                setChatId(chatId).
                setText(text).
                setReplyMarkup(showReplyKeyboardMarkup(getKeyboard("Выход")));
    }
    protected SendMessage sendMsg (String text,String chatId) throws TelegramApiException {
        return new SendMessage().
                setChatId(chatId).
                setText(text).
                setReplyMarkup(showReplyKeyboardMarkup(getKeyboard("Календарь \uD83D\uDCC5","\n", "Обо мне \uD83E\uDD16")));
